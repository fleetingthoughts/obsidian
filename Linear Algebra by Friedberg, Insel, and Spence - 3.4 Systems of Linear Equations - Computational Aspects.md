...
- ***Theorem 3.16*** If we know the rank, what can we say about the row reduced echelon form.

# Definitions
- Equivalent.  Same solution set

# Theorems
***Theorem 3.13.*** Invertible linear transformation of a system preserves the solution set.

***Corollary to Theorem 3.16.*** The reduced row echelon form of a matrix is unique
