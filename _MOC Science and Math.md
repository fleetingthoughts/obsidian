...
3) William Feller- Introduction to Probability
4) IMLSP
5) E.P. Box
## Analysis
...
4) Walter Rudin - Principles of Mathematical Analysis (11 chapters/ 1 chapter per week = 11 weeks.)
5) John B. Conway - Functions of One Complex Variable I
6) John B. Conway - Functions of One Complex Variable II
7) Lars Alfohrs - Complex Analysis
## Differential Equations
1) Simmons - Differential Equations with Applications and Historical Notes
2) Hirsch - _**Differential Equations, Dynamical Systems, and Linear Algebra**_ 
3) Coddington -  _**Theory of ordinary differential equations**_
## Linear Algebra
1) Strang - Linear Algebra (Finish by Nov. 22)
2) Friedberg, Insel Linear Algebra - (Start Dec. 14th finish Feb 28th)
3) Paul Halmos - Finite-Dimensional Vector Spaces (has tensors)
4) Hoffman and Ray Kunze - Linear Algebra
## Discrete Mathematics
- Knuth
## Abstract Algebra
- Michael Artin - Algebra
- Israel Nathan Herstein -Topics in algebra 
