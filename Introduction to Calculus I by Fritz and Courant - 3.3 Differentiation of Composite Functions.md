...
# Application of chain rule: complete our analytical continuation of the power function and use chain rule to easily compute the derivative of power functions.
