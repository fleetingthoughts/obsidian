...
It should be noted that convergence is a sufficient condition for a bound to exist and is not necessary (i.e. a bounded sequence is not sufficient for convergence).
