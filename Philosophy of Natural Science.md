...
reprint publisher: Pearson Education Reprints
original publication year: "1966"
edition publication year: "1966"
isbn-13: 978-0136638230
cover: https://upload.wikimedia.org/wikipedia/en/3/31/Philosophy_of_Natural_Science.jpg
tags:
  - "#book"
  - carl_hempel
  - science
...
---
My motivations for reading this book comes from [Peter-Godfrey Smith's introductory book to the philosophy of science](Theory%20and%20Reality%20-%20Introduction%20to%20the%20Philosophy%20of%20Science.md) where he cites Hempel's work as an introduction to the logical positivists/empiricists. Philosophy of Natural Science was quoted in the suggested readings at the end of Chapter 2 to be a (former) classic introduction to the topic. While many of the views have been criticized, abandoned, and considered dead, such as the covering law model in this book, I think there is use in examining what is largely seen as one of the first pushes into what we now call the modern philosophy of science and understand how it was explained and why it failed. Additionally while views may have failed, there are still concepts and ideas that more current fields have taken from logical positivism, such as [Unificationism refining the covering law model](Theory%20and%20Reality%20-%2013%20Explanation.md) so there is still value to be extracted in the ideas even if the overall concept was deemed a failure.

The book discusses the empirical sciences (as opposed to non-empirical fields such as math) and specifically natural sciences which is distinguished from social sciences. The goal is to explain "how the principles objectives of scientific inquiry are achieved". The following topics and questions are addressed:
- How Scientific knowledge is arrived at
- How is scientific knowledge supported
- How scientific knowledge changes
- How science explains empirical facts
- What kind of understandings do explanations give us
- The presuppositions and limitations innate to science

As I have done with PGS's book, I will break down the text by the key terms used, and the historical examples cited since so much of philosophy derives their justification from past experiences. Philosophy of science in particular enjoys the experiences that are not personal to us but are of significant figures in the past, and so, it goes through a layer of historical interpretation.
