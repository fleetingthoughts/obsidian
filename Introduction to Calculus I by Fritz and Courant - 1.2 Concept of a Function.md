...
***Theorem on sufficient conditions for a Uniformly continuous function (p.42).*** A function who's domain is a closed and bounded interval is uniformly continuous in that interval.
...
$$|f(x)-f(x_0)|\le L|x-x_1| < \epsilon \text{\quad for\quad}L\in \mathbb{R}$$
