...
- The idea of an irrational numbers, $\alpha$  a sequence of rational numbers, $r$ approaching the $\alpha$ as a limit (i.e. $\lim\limits_{n\to \infty}(r_n)=\alpha$) and using this concept to define exponentials and logarithms of irrational numbers.
