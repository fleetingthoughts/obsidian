...
- the use of an auxillary test to tune the size of the critical area in the case of discrete random variables.
- The use of the p-value to provide a common metric among many randomized tests.
