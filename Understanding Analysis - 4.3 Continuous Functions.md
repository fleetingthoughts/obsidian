...
- The definition of continuity and how it is distinguished from the definition of the functional limit by requiring the target point to be in the domain.
...
# The functional limit at a point distinguished from continuity at a point.
...
- ***On the set of limit points, the functional limit is strictly weaker than continuity.*** If $x=c$ is a limit point, then continuity implies the functional limit exists, but the converse is not true.
