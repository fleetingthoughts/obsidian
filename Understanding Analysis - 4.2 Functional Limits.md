...
***The definition of the functional limit does not require the limit point to be in the domain.*** We only require the domain to have a limit point but not for that limit point to be an element of the domain, that is, the domain is not necessarily a closed set.
