...
This is effectively what is meant by the "decimal base system". In fact we can carry out this process not subdivision of 10 equal parts, but by divisions of 2 or 3 for a base 2 or base 3 representation of $x$. This representation of $x$ does create ambiguity and the author's solution is to simply exclude decimal representations of terminating in infinite 9's.
