...
5. What are the main special terms the author uses
	- Make your own index
6. What are the central propositions being made
	- Number in the margin these special propositions and note their pages
	- Inductive vs deductive
	- Tests of your understanding: Can you state in your own terms? Can you relate it to your own experience
7. How do the propositions relate to each other to form arguments
	- Go back to 2), which of those propositions and classify them as follows:
		- What are their axioms or assumptions taken for granted
		- Are the propositions deductive or inductive in nature
8. Determine if the author has answered the questions he aimed to solve.
...
- [How to read History](How%20to%20read%20History.md)
- [[How to read Science and Mathematics]]
- [[How to Read Social Science literature]]
# Tips
- Read with a pointer
- Mark the book
...
I need a legend, or structure to annotate with. I also need to outline how I'm structure or outlining the book beforehand which will depend on how I classify it.
- Numbering to provide overall structure within chapter
- Q: Question
