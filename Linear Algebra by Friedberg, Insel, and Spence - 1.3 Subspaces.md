...
***Theorem 1.3 (redundancy of the additive inverse condition)*** A subset$W$ of the vector space $V$ is a subspace if and only if the subspace is closed under addition, scalar multiplication, and it has the 0 vector.
